...
BYTE DLT634_5104_SLAVE_H_SOE(BYTE pdrv)//判断是否有soe
{ 
//    switch(pdrv)
//    {
//        case 0:
...
void DLT634_5104_SLAVE_R_SOE(BYTE pdrv, BYTE *pbuf)//读soe
{ 
//    BYTE buf[256];
//    BYTE i;
...
BYTE DLT634_5104_SLAVE_H_NVA(BYTE pdrv)//判断是否有NVA
{ 
//    switch(pdrv)
//    {
//        case 0:
...
void DLT634_5104_SLAVE_R_NVA(BYTE pdrv, BYTE *pbuf)//读NVA
{ 
//    BYTE buf[256];
//    BYTE i;
...
BYTE DLT634_5104_SLAVE_H_FEvent(BYTE pdrv)//判断是否有FEvent
{ 
//	switch(pdrv)
//	{
//		case 0:
...
void DLT634_5104_SLAVE_R_FEvent(BYTE pdrv, BYTE *pbuf)//读FEvent
{ 
//	BYTE buf[256];
//	BYTE i;
//	BYTE temp1,temp2;
